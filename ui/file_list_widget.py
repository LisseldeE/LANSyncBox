...
class FileListWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self._sel_status_label.setStyleSheet(f"color: {'#6c757d' if _lum > 128 else '#9a9ea6'}; font-size: 12px;")
        action_bar_layout.addWidget(self._sel_status_label, 0, Qt.AlignVCenter)
